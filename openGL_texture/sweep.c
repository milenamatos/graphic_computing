...
void sweep01(){
    ...
    for(int i=0;i<10;i++){
        glBegin(GL_QUAD_STRIP);
            ...
            glNormal3f(-0.5,-0.5+ty1,-0.5);
            glVertex3f(-0.5,-0.5+ty1,-0.5);
            glNormal3f(0.5,-0.5+ty,-0.5);
            glVertex3f(0.5,-0.5+ty,-0.5);
            glNormal3f(0.5,-0.5+ty1,-0.5);
            glVertex3f(0.5,-0.5+ty1,-0.5);
            ...
            glNormal3f(0.5,-0.5+ty1,0.5);
            glVertex3f(0.5,-0.5+ty1,0.5);
            glNormal3f(0.25,-0.5+ty,0.5);
            glVertex3f(0.25,-0.5+ty,0.5);
            glNormal3f(0.25,-0.5+ty1,0.5);
            glVertex3f(0.25,-0.5+ty1,0.5);
        
            glNormal3f(0.25,-0.5+ty,-0.25);
            glVertex3f(0.25,-0.5+ty,-0.25);
            glNormal3f(0.25,-0.5+ty1,-0.25);
            glVertex3f(0.25,-0.5+ty1,-0.25);
            glNormal3f(-0.25,-0.5+ty,-0.25);
            glVertex3f(-0.25,-0.5+ty,-0.25);
            glNormal3f(-0.25,-0.5+ty1,-0.25);
            glVertex3f(-0.25,-0.5+ty1,-0.25);
